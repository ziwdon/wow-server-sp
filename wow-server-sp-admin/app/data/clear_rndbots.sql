-- clear_rndbots.sql — DESTRUCTIVE. Deletes the entire RNDBOT% pool + orphans.
-- Bundled verbatim from gamemaster ref-useful-sql.md (noisiver delete_playerbots.sql).
-- Run ONLY with ac-worldserver stopped, piped as ONE script to root mysql.
-- DO NOT parameterize or assemble this from variables.
