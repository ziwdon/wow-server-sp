# Planned To Dos for the project
- Backup restore feature to wow-server-sp-admin
- Backup purging / rotation
- add quest money config to default install server script
